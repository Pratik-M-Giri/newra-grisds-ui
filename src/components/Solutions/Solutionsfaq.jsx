    ...
    import windPong from "../../assets/solutionfaq.png"; 
    ...
    return <>
      ...
      <div 
        ...
        style={{ 
            bottom: "0", 
            right: "0", 
            width: "50%", // Photo ke hisaab se size set kiya
            maxWidth: "600px",
            display: "flex",
      ...
      >
        <img 
          ...
          className="w-full mr-20 h-auto object-contain opacity-80" 
          style={{ transform: "translate(10%, 10%)" }} // Thoda edge se bahar nikalne ke liye
        />
      </div>
