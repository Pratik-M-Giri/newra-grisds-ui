    ...
    <section className="w-full flex items-center justify-center bg-white overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            <h2 style={{ fontFamily: "Glonto", fontSize: "32px", fontWeight: 400 }}>
              Talk to Our Energy Experts
            </h2>
            <p style={{ fontFamily: "Instrument Sans", fontSize: "16px" }}>
              Explore how NRG can help you save on power costs, stay compliant, and switch to clean energy.
            </p>
          </div>
